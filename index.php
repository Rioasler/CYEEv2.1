...
<html lang="en-US">
<head>
<title>CYEE - Certainty and Evidence</title>
<meta charset="utf-8">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>CYEE<br>
							 Certainty and Evidence</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 проєкт, який надає допомогу людям, до яких було застосовано шахрайські дії або обман в інтернет-магазинах, особливо на платформі Instagram. Ми допомагаємо в розслідуванні таких випадків і забезпечуємо клієнтам докази для подання скарг у відповідні органи.
							</p>
